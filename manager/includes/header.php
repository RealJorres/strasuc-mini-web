...
<head>
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css?v=<?php echo time(); ?>" rel="stylesheet">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="../universities/index.php">
                                        <i class="fas fa-list me-1"></i>View All
                                    </a></li>
                                <?php if ($_SESSION['user']['role'] === 'admin'): ?>
                                    <li><a class="dropdown-item" href="../universities/create.php">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="../sports/index.php">
                                        <i class="fas fa-list me-1"></i>View All
                                    </a></li>
                                <?php if ($_SESSION['user']['role'] === 'admin'): ?>
                                    <li><a class="dropdown-item" href="../sports/create.php">
                                            <i class="fas fa-plus me-1"></i>Add New
                                        </a></li>
                                <?php endif; ?>
                            </ul>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="../teams/index.php">
                                        <i class="fas fa-list me-1"></i>View All
                                    </a></li>
                                <li><a class="dropdown-item" href="../teams/create.php">
                                        <i class="fas fa-plus me-1"></i>Add New
                                    </a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="../schedules/index.php">
                                        <i class="fas fa-list me-1"></i>View All
                                    </a></li>
                                <li><a class="dropdown-item" href="../schedules/create.php">
                                        <i class="fas fa-plus me-1"></i>Add New
                                    </a></li>
                            </ul>
                        </li>
                        <!-- <li class="nav-item">
                            <a class="nav-link" href="../medal-refs/index.php">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="../participants/index.php">
                                        <i class="fas fa-user-friends me-1"></i>Participants
                                    </a></li>
                                <li><a class="dropdown-item" href="../scores/index.php">
                                        <i class="fas fa-chart-line me-1"></i>Scores
                                    </a></li>
                                <li><a class="dropdown-item" href="../medals/index.php">
                                    ...
                                    <?php if ($_SESSION['user']['role'] === "admin"): ?>
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="../users/index.php">
                                                <i class="fa-solid fa-people-roof me-1"></i>Account Management
                                            </a>
                                        </li>
                                        <li>
                                            <hr class="dropdown-divider">
                ...
                <?php else: ?>
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../medals/index.php">
                                <i class="fas fa-trophy me-1"></i>Medals
                            </a>
                        </li>
                    </ul>
